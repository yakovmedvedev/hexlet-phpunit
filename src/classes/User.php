...
// $user = new Classes\User('Ivan');
// print_r($user);
// print_r("\n");
// $address = new Classes\User\Address('Russia', 'Moscow', 'Lenina');
// $address2 = new Classes\User\Address('Russia', 'Leningrad', 'Enina');
...
//Такое часто встречается в интернет магазинах, когда у одного пользователя может быть
